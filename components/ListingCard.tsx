...
export function ListingCard({ listing, index = 0 }: { listing: Listing; index?: number }) {
  ...
  return (
    <Link
      ...
      className="group flex animate-fade-up flex-col overflow-hidden rounded-lg border border-line bg-card transition-all duration-300 ease-out hover:-translate-y-1 hover:border-amber/40 hover:shadow-hover motion-reduce:animate-none motion-reduce:transform-none"
    >
      ...
      <div className="flex flex-1 flex-col p-3">
        <p className="text-[15px] font-bold leading-snug text-ink line-clamp-2">{listing.title}</p>
